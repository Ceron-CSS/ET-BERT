...
_category = 41 # dataset class
dataset_dir = "/workspace/origin-ET-BERT/tsv/gray_acip_aes-128-gcm_only_non_ecnrypted_descrip_disorder/" # the path to save dataset for dine-tuning

pcap_path, dataset_save_path, samples, features, dataset_level = "/data/gray/CipherSpectrum/aes-128-gcm_payload_only_non_ecnrypted_descrip_disorder/pcap_aug/", "/workspace/origin-ET-BERT/npy/gray_acip_aes-128-gcm_only_non_ecnrypted_descrip_disorder/", [3000], ["payload"], "flow"
